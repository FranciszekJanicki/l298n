...
static l298n_err_t l298n_channel_gpio_initialize(l298n_channel_t const* channel)
{
...
static l298n_err_t l298n_channel_gpio_deinitialize(l298n_channel_t const* channel)
{
    return channel->interface.gpio_deinitialize
               ? channel->interface.gpio_deinitialize(channel->interface.gpio_user)
               : L298N_ERR_NULL;
}
...
static l298n_err_t l298n_channel_pwm_initialize(l298n_channel_t const* channel)
{
...
static l298n_err_t l298n_channel_pwm_initialize(l298n_channel_t const* channel)
{
    return channel->interface.pwm_deinitialize
               ? channel->interface.pwm_deinitialize(channel->interface.pwm_deinitialize)
               : L298N_ERR_NULL;
}
...
static l298n_err_t l298n_channel_adc_initialize(l298n_channel_t const* channel)
{
...
static l298n_err_t l298n_channel_adc_deinitialize(l298n_channel_t const* channel)
{
