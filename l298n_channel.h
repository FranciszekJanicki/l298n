...
l298n_err_t l298n_channel_initialize(
    l298n_channel_t* channel,
...
l298n_err_t l298n_channel_set_backward_direction(
    l298n_channel_t const* channel);
l298n_err_t l298n_channel_set_soft_stop_direction(
    l298n_channel_t const* channel);
