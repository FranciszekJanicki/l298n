...
typedef struct {
  void *gpio_user;
  l298n_err_t (*gpio_initialize)(void *);
  l298n_err_t (*gpio_deinitialize)(void *);
  l298n_err_t (*gpio_write)(void *, uint32_t, bool);
  l298n_err_t (*gpio_read)(void *, uint32_t, bool *);

  void *pwm_user;
  l298n_err_t (*pwm_initialize)(void *);
  l298n_err_t (*pwm_deinitialize)(void *);
  l298n_err_t (*pwm_set_compare)(void *, uint32_t);

  void *adc_user;
  l298n_err_t (*adc_initialize)(void *);
  l298n_err_t (*adc_deinitialize)(void *);
